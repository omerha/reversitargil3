...
initBoard();
    ...
    function initBoard(){
        ...
        var body = $(".boardBody").css("pointer-events","none"); //-- makes board unclick able

        console.log("CHECEHCEHCECHEC");
    ...
    function addPlayerToBoard(player){
        ...
        var playerNumOfMoves =$(document.createElement("td")).text(player.numOfMoves);
